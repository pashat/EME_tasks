<table id="sortedTable" class="center table table-bordered table-hover table-condensed">
    <thead><tr><th title="Field #1">ID</th>
        <th title="Field #2">Country
            <a href="javascript:void(0)" onclick="sortTableAbc()"><i class="fa fa-angle-up"></i></a>
